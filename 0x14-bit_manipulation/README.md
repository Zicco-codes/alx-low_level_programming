...
Your file should contain the exact password, no new line, no extra space1. Write a function that converts a binary number to an unsigned int.
...
Save the password in the file 101-password
Your file should contain the exact password, no new line, no extra space1
